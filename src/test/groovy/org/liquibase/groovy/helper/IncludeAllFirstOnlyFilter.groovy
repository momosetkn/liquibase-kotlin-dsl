...
/**
 * This class is a helper for the {@code DatabaseChangeLogDelegateTests} class.  It is an
 * implementation of the Liquibase {@code IncludeAllFilter} that includes all files that have
 * "first" in the name.
 *
