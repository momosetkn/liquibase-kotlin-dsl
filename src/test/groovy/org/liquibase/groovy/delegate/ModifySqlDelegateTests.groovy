...
/**
 * Test class for the {@link ModifySqlDelegate}.  As usual, we're only verifying that we can pass
 * things to Liquibase correctly. We check all attributes that are known at this time - note that
 * several are undocumented.  Thia
 *
...
class ModifySqlDelegateTests {
    ...
    /**
     * Test the append element with no attributes. This time, we'll also make sure we can set
     * applyToRollback to true.
     */
    @Test
    void appendEmpty() {
    ...
    /**
     * Test the prepend element with no attributes. Validate the default "applyToRollback" value of
     * false.
     */
    @Test
    void prependEmpty() {
    ...
    /**
     * Test the prepend element with all supported attributes.  For this test, we will also set a
     * dbms.
     */
    @Test
    void prependFull() {
    ...
    /**
     * Test the replace element with no attributes. This time, we'll try to explicitly set
     * applyToRollback to false.
     */
    @Test
    void replaceEmpty() {
    ...
    /**
     * Test the replace element with all supported attributes.  For this test, we will also set a 2
     * databases to test that it gets split correctly.
     */
    @Test
    void replaceFull() {
    ...
    /**
     * Test the regExpReplace element with no attributes. This time, we'll also make sure we can
     * set applyToRollback to the string "true".
     */
    @Test
    ...
    /**
     * Test the regExpReplace element with all supported attributes.  For this test, we will also
     * set two contexts.
     */
    @Test
