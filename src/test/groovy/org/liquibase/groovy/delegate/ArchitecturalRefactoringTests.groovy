 ...
 * without both a table name and at least one column.  If a user tries it, they will get errors from
 * Liquibase itself.
 *
...
class ArchitecturalRefactoringTests extends ChangeSetTests {
    ...
    /**
     * Test parsing a dropIndex change with no attributes to make sure the DSL doesn't introduce
     * unexpected defaults.
     */
    @Test
    void dropIndexEmpty() {
